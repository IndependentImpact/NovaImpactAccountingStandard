...
class ValidationVerificationReportRenderingTests(unittest.TestCase):
    ...
    def test_blank_templates_contain_expected_report_sections(self):
        ...
        self.assertIn("## Section 1. Global PDD Evaluation", rendered)
        self.assertIn("## Section 3. PDD Paragraph-Level Validation Findings", rendered)
        self.assertIn("## Section 4. Validation VVS Requirement Coverage", rendered)
    ...
    def test_workflow_and_document_envelope_render_in_appendix_only(self):
        rendered = self._render_draft("validation")
        self.assertLess(
            rendered.index("## Section 4. Validation VVS Requirement Coverage"),
