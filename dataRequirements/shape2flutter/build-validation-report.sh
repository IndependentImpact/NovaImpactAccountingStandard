...
OUT_BASE="${OUT_BASE%/}"
OUT_ROOT="${OUT_ROOT:-$OUT_BASE/nias-shape2flutter/validation-report}"
SHAPES_FILE="$ROOT_DIR/dataRequirements/shape2flutter/validation-report-ui-shapes.ttl"
...
printf 'shape2flutter validation report output:\n'
